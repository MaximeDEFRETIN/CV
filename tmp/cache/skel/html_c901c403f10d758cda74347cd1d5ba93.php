...
/*
 * Squelette : ../plugins/auto/saisies/v3.34.0/saisies.css.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Sun, 08 Mar 2020 09:52:51 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/auto/saisies/v3.34.0/saisies.css.html
// Temps de compilation total: 1.007 ms
//

function html_c901c403f10d758cda74347cd1d5ba93($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
((find_in_path('prive/style_prive_plugin_bonux.html'))  ?
		(' ' . (	' 
  ' .
	recuperer_fond( 'prive/style_prive_plugin_bonux' , array('ltr' => lang_dir(@$Pile[0]['lang'], 'left','right') ), array('compil'=>array('../plugins/auto/saisies/v3.34.0/saisies.css.html','html_c901c403f10d758cda74347cd1d5ba93','',22,$GLOBALS['spip_lang'])), _request('connect')) .
	'
')) :
		'') .
'
...
');
	...
	return analyse_resultat_skel('html_c901c403f10d758cda74347cd1d5ba93', $Cache, $page, '../plugins/auto/saisies/v3.34.0/saisies.css.html');
}
?>