...
/*
 * Squelette : plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html
...
function BOUCLE_normaliser_auteurshtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_normaliser_auteurs',36,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
vide($Pile['vars'][$_zzz=(string)'auteurs'] = filtre_push(table_valeur($Pile["vars"], (string)'auteurs', null),interdire_scripts(textebrut(supprimer_tags(html_entity_decode(trim(safehtml($Pile[$SP]['valeur'])))))))));
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_normaliser_auteurs @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_normaliser_motshtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_normaliser_mots',43,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
vide($Pile['vars'][$_zzz=(string)'mots'] = filtre_push(table_valeur($Pile["vars"], (string)'mots', null),interdire_scripts(textebrut(supprimer_tags(html_entity_decode(trim(safehtml($Pile[$SP]['valeur'])))))))));
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_normaliser_mots @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_normaliser_logoshtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_normaliser_logos',50,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_normaliser_logos @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_auteurs_dublincorehtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_auteurs_dublincore',94,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_auteurs_dublincore @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_mots_dublincorehtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_mots_dublincore',97,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_mots_dublincore @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_dublincorehtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"CONDITION",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_dublincore',80,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'
' .
BOUCLE_auteurs_dublincorehtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
' .
BOUCLE_mots_dublincorehtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	$iter->free();
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_dublincore @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_logos_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_logos_opengraph',126,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_logos_opengraph @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_auteurs_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_auteurs_opengraph',145,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_auteurs_opengraph @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_mots_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_mots_opengraph',148,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_mots_opengraph @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_article_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"CONDITION",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_article_opengraph',142,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'
' .
BOUCLE_auteurs_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
' .
BOUCLE_mots_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	$iter->free();
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_article_opengraph @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"CONDITION",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_opengraph',113,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
BOUCLE_logos_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
' .
BOUCLE_article_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_opengraph @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_images_twitterhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_images_twitter',175,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_images_twitter @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_twitterhtml_7bf3f6cf1182b6e87f10b228acb8402c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"CONDITION",
		$command,
		array('plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html','html_7bf3f6cf1182b6e87f10b228acb8402c','_twitter',166,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
BOUCLE_images_twitterhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');
	}
	$iter->free();
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_twitter @ plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html
// Temps de compilation total: 11.801 ms
//

function html_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
BOUCLE_normaliser_auteurshtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'

' .
vide($Pile['vars'][$_zzz=(string)'mots'] = array()) .
BOUCLE_normaliser_motshtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'

' .
vide($Pile['vars'][$_zzz=(string)'logos'] = array()) .
BOUCLE_normaliser_logoshtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'


' .
BOUCLE_dublincorehtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'

' .
BOUCLE_opengraphhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'

' .
BOUCLE_twitterhtml_7bf3f6cf1182b6e87f10b228acb8402c($Cache, $Pile, $doublons, $Numrows, $SP) .
'

' .
'<' . '?php header("X-Spip-Filtre: '.'trim' . '"); ?'.'>');

	return analyse_resultat_skel('html_7bf3f6cf1182b6e87f10b228acb8402c', $Cache, $page, 'plugins/auto/metasplus/v2.3.2/inclure/metasplus/inc-dist.html');
}
?>