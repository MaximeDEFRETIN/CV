 ...
 * Date :      Mon, 10 Feb 2020 16:50:05 GMT
 * Compile :   Thu, 27 Feb 2020 09:06:46 GMT
 * Boucles :   _art
 */ 
...
filtre_nettoyer_titre_email_dist(_T('info_publie_1',array('nom_site_spip' => interdire_scripts(typo($GLOBALS['meta']['nom_site'], "TYPO", $connect, $Pile[0])), 'titre' => interdire_scripts(supprimer_numero(typo($Pile[$SP]['titre']), "TYPO", $connect, $Pile[0]))))) .
'
...
' .
_T('info_publie_01',array('titre' => interdire_scripts(supprimer_numero(typo($Pile[$SP]['titre']), "TYPO", $connect, $Pile[0])), 'connect_nom' => interdire_scripts(invalideur_session($Cache, table_valeur($GLOBALS["visiteur_session"], (string)'nom', null))))) .
'
