...
/*
 * Squelette : ../prive/formulaires/configurer_redacteurs.html
 * Date :      Mon, 10 Feb 2020 16:50:03 GMT
 * Compile :   Thu, 27 Feb 2020 08:57:56 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../prive/formulaires/configurer_redacteurs.html
// Temps de compilation total: 0.480 ms
//

function html_3840fee6b9231e7442496c8798b2ce85($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
interdire_scripts(chemin_image('auteur-1comite-24.png')) .
'" class="cadre-icone" />' .
_T('public|spip|ecrire:info_inscription_automatique') .
'</h3>
	' .
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
		($t1 . (	'
	<p>' .
	_T('public|spip|ecrire:info_question_inscription_nouveaux_redacteurs') .
	'</p>
	...
	'</div>
		<div class="editer-groupe">
			' .
	vide($Pile['vars'][$_zzz=(string)'name'] = 'accepter_inscriptions') .
	...
	table_valeur($Pile["vars"], (string)'name', null) .
	'_oui">' .
	_T('public|spip|ecrire:item_accepter_inscriptions') .
	'</label>
					</div>
					<div class="choix">
						<input type="radio" name="' .
	...
	table_valeur($Pile["vars"], (string)'name', null) .
	'_non">' .
	_T('public|spip|ecrire:item_non_accepter_inscriptions') .
	'</label>
					</div>
			</div>
		</div>
...
');
	...
	return analyse_resultat_skel('html_3840fee6b9231e7442496c8798b2ce85', $Cache, $page, '../prive/formulaires/configurer_redacteurs.html');
}
?>