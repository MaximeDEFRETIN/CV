...
/*
 * Squelette : ../plugins/auto/saisies/v3.33.0/saisies.css.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Thu, 27 Feb 2020 08:49:07 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/auto/saisies/v3.33.0/saisies.css.html
// Temps de compilation total: 2.459 ms
//

function html_a26694d785cd173f26f68f23d4f5551a($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
((find_in_path('prive/style_prive_plugin_bonux.html'))  ?
		(' ' . (	' 
  ' .
	recuperer_fond( 'prive/style_prive_plugin_bonux' , array('ltr' => lang_dir(@$Pile[0]['lang'], 'left','right') ), array('compil'=>array('../plugins/auto/saisies/v3.33.0/saisies.css.html','html_a26694d785cd173f26f68f23d4f5551a','',22,$GLOBALS['spip_lang'])), _request('connect')) .
	'
')) :
		'') .
'
...
');
	...
	return analyse_resultat_skel('html_a26694d785cd173f26f68f23d4f5551a', $Cache, $page, '../plugins/auto/saisies/v3.33.0/saisies.css.html');
}
?>