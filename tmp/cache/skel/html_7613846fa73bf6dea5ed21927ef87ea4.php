...
/*
 * Squelette : ../plugins/auto/saisies/v3.31.3/saisies/checkbox.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Wed, 05 Feb 2020 16:19:35 GMT
 * Boucles :   _checkbox_groupes, _groupes, _checkbox
 */ 

function BOUCLE_checkbox_groupeshtml_7613846fa73bf6dea5ed21927ef87ea4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins/auto/saisies/v3.31.3/saisies/checkbox.html','html_7613846fa73bf6dea5ed21927ef87ea4','_checkbox_groupes',59,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'</label>
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_checkbox_groupes @ ../plugins/auto/saisies/v3.31.3/saisies/checkbox.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_groupeshtml_7613846fa73bf6dea5ed21927ef87ea4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"CONDITION",
		$command,
		array('../plugins/auto/saisies/v3.31.3/saisies/checkbox.html','html_7613846fa73bf6dea5ed21927ef87ea4','_groupes',56,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'</em>
	' .
BOUCLE_checkbox_groupeshtml_7613846fa73bf6dea5ed21927ef87ea4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
</div>
');
	}
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_groupes @ ../plugins/auto/saisies/v3.31.3/saisies/checkbox.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}


function BOUCLE_checkboxhtml_7613846fa73bf6dea5ed21927ef87ea4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins/auto/saisies/v3.31.3/saisies/checkbox.html','html_7613846fa73bf6dea5ed21927ef87ea4','_checkbox',54,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
' .
(($t1 = BOUCLE_groupeshtml_7613846fa73bf6dea5ed21927ef87ea4($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		$t1 :
		((	'
...
');
	...
	if (defined("_BOUCLE_PROFILER")
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_checkbox @ ../plugins/auto/saisies/v3.31.3/saisies/checkbox.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins/auto/saisies/v3.31.3/saisies/checkbox.html
// Temps de compilation total: 8.757 ms
//

function html_7613846fa73bf6dea5ed21927ef87ea4($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
' .
(($t1 = BOUCLE_checkboxhtml_7613846fa73bf6dea5ed21927ef87ea4($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		($t1 . (	'
...
');
	...
	return analyse_resultat_skel('html_7613846fa73bf6dea5ed21927ef87ea4', $Cache, $page, '../plugins/auto/saisies/v3.31.3/saisies/checkbox.html');
}
?>