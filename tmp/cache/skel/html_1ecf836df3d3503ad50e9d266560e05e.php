...
function BOUCLE_proposerhtml_1ecf836df3d3503ad50e9d266560e05e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/contenu/article.html','html_1ecf836df3d3503ad50e9d266560e05e','_proposer',31,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
' .
vide($Pile['vars'][$_zzz=(string)'options'] = array()) .
(($t1 = strval(interdire_scripts(((($Pile[$SP]['statut'] == 'prop')) ?' ' :''))))!=='' ?
		($t1 . (	vide($Pile['vars'][$_zzz=(string)'options'] = array('label_date' => _T('public|spip|ecrire:texte_date_publication_objet'))) .
	' ')) :
		'') .
'
<div class="ajax">
...
executer_balise_dynamique('FORMULAIRE_DATER',
	...
	array('../prive/squelettes/contenu/article.html','html_1ecf836df3d3503ad50e9d266560e05e','_article',9,$GLOBALS['spip_lang'])) .
'</div>
...
executer_balise_dynamique('FORMULAIRE_EDITER_LIENS',
	...
	array('../prive/squelettes/contenu/article.html','html_1ecf836df3d3503ad50e9d266560e05e','_article',12,$GLOBALS['spip_lang'])) .
'</div>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/contenu/article') . ', array(\'id\' => ' . argumenter_squelette($Pile[$SP]['id_article']) . ',
	...
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'../prive/squelettes/contenu/article.html\',\'html_1ecf836df3d3503ad50e9d266560e05e\',\'\',46,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette('wysiwyg') . '))?$v:true), _request("connect"));
?'.'>
</div>
...
// Temps de compilation total: 39.020 ms
//
