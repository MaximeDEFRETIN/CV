...
function html_2b79d4d7bff4d0ad7a1dcadddbb3a645($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
		($t1 . (	'
	' .
	vide($Pile['vars'][$_zzz=(string)'titre'] = _T('public|spip|ecrire:icone_suivi_activite')) .
	'
	<p>' .
...
'titre' => table_valeur($Pile["vars"], (string)'titre', null))) .
	...
	'</div>
		<div class="editer-groupe">
			' .
	vide($Pile['vars'][$_zzz=(string)'name'] = 'syndication_integrale') .
...
'
	...
	return analyse_resultat_skel('html_2b79d4d7bff4d0ad7a1dcadddbb3a645', $Cache, $page, '../prive/formulaires/configurer_flux.html');
}
?>