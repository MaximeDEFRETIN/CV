...
/*
 * Squelette : ../plugins/auto/saisies/v3.31.3/saisies/radio.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Wed, 05 Feb 2020 16:19:35 GMT
 * Boucles :   _radio
 */ 

function BOUCLE_radiohtml_f4118ea6d747040d6092de6a436f7b07(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins/auto/saisies/v3.31.3/saisies/radio.html','html_f4118ea6d747040d6092de6a436f7b07','_radio',28,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
');
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_radio @ ../plugins/auto/saisies/v3.31.3/saisies/radio.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins/auto/saisies/v3.31.3/saisies/radio.html
// Temps de compilation total: 3.040 ms
//

function html_f4118ea6d747040d6092de6a436f7b07($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
BOUCLE_radiohtml_f4118ea6d747040d6092de6a436f7b07($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_f4118ea6d747040d6092de6a436f7b07', $Cache, $page, '../plugins/auto/saisies/v3.31.3/saisies/radio.html');
}
?>