...
/*
 * Squelette : ../plugins/auto/saisies/v3.36.2/saisies/_base.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Mon, 16 Mar 2020 15:17:04 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/auto/saisies/v3.36.2/saisies/_base.html
// Temps de compilation total: 1.252 ms
//

function html_85272efedd81ef2c6e9df7b728a8f9bf($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = strval(interdire_scripts(((entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)) ?' ' :''))))!=='' ?
	...
	'readonly' => table_valeur($Pile["vars"], (string)'readonly', null) )), array('compil'=>array('../plugins/auto/saisies/v3.36.2/saisies/_base.html','html_85272efedd81ef2c6e9df7b728a8f9bf','',12,$GLOBALS['spip_lang'])), _request('connect')) .
		'
	')) :
			'') .
	'
	...
	'describedby' => interdire_scripts((table_valeur(@$Pile[0], (string)'explication', null) ? (($t5 = strval(interdire_scripts(saisie_nom2name(entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)))))!=='' ?
						('explication_' . $t5) :
						''):'')) )), array('compil'=>array('../plugins/auto/saisies/v3.36.2/saisies/_base.html','html_85272efedd81ef2c6e9df7b728a8f9bf','',0,$GLOBALS['spip_lang'])), _request('connect')) .
		'
			' .
...
');
	...
	return analyse_resultat_skel('html_85272efedd81ef2c6e9df7b728a8f9bf', $Cache, $page, '../plugins/auto/saisies/v3.36.2/saisies/_base.html');
}
?>