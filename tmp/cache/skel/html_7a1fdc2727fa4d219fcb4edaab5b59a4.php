...
/*
 * Squelette : ../plugins/auto/saisies/v3.31.3/saisies.css.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Wed, 05 Feb 2020 15:29:12 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/auto/saisies/v3.31.3/saisies.css.html
// Temps de compilation total: 1.128 ms
//

function html_7a1fdc2727fa4d219fcb4edaab5b59a4($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
((find_in_path('prive/style_prive_plugin_bonux.html'))  ?
		(' ' . (	' 
  ' .
	recuperer_fond( 'prive/style_prive_plugin_bonux' , array('ltr' => lang_dir(@$Pile[0]['lang'], 'left','right') ), array('compil'=>array('../plugins/auto/saisies/v3.31.3/saisies.css.html','html_7a1fdc2727fa4d219fcb4edaab5b59a4','',22,$GLOBALS['spip_lang'])), _request('connect')) .
	'
')) :
		'') .
'
...
');
	...
	return analyse_resultat_skel('html_7a1fdc2727fa4d219fcb4edaab5b59a4', $Cache, $page, '../plugins/auto/saisies/v3.31.3/saisies.css.html');
}
?>