...
/*
 * Squelette : ../plugins/auto/saisies/v3.36.2/saisies.css.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Thu, 19 Mar 2020 14:46:38 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/auto/saisies/v3.36.2/saisies.css.html
// Temps de compilation total: 0.553 ms
//

function html_d4cec07cc941c5168219a178860ccfb8($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
((find_in_path('prive/style_prive_plugin_bonux.html'))  ?
		(' ' . (	' 
  ' .
	recuperer_fond( 'prive/style_prive_plugin_bonux' , array('ltr' => lang_dir(@$Pile[0]['lang'], 'left','right') ), array('compil'=>array('../plugins/auto/saisies/v3.36.2/saisies.css.html','html_d4cec07cc941c5168219a178860ccfb8','',22,$GLOBALS['spip_lang'])), _request('connect')) .
	'
')) :
		'') .
'
...
');
	...
	return analyse_resultat_skel('html_d4cec07cc941c5168219a178860ccfb8', $Cache, $page, '../plugins/auto/saisies/v3.36.2/saisies.css.html');
}
?>