 ...
 * Date :      Mon, 02 Mar 2020 13:57:24 GMT
 * Compile :   Mon, 02 Mar 2020 18:42:48 GMT
 * Boucles :   _mots
 */ 

function BOUCLE_motshtml_cec175a1c084c4612c25379ae1001bbe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/modeles/article_mots.html','html_cec175a1c084c4612c25379ae1001bbe','_mots',11,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function html_cec175a1c084c4612c25379ae1001bbe($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
(($t1 = BOUCLE_motshtml_cec175a1c084c4612c25379ae1001bbe($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
    <div class="menu"' .
...
');
	...
	return analyse_resultat_skel('html_cec175a1c084c4612c25379ae1001bbe', $Cache, $page, 'squelettes/modeles/article_mots.html');
}
?>