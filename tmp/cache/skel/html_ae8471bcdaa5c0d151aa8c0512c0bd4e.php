 ...
 * Date :      Mon, 02 Mar 2020 13:57:12 GMT
 * Compile :   Mon, 02 Mar 2020 15:33:02 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette squelettes/404.html
// Temps de compilation total: 7.436 ms
//

function html_ae8471bcdaa5c0d151aa8c0512c0bd4e($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/head') . ', array(\'robots\' => ' . argumenter_squelette('none') . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes/404.html\',\'html_ae8471bcdaa5c0d151aa8c0512c0bd4e\',\'\',13,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
</head>
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/header') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes/404.html\',\'html_ae8471bcdaa5c0d151aa8c0512c0bd4e\',\'\',17,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
        ' .

'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/nav') . ', array_merge('.var_export($Pile[0],1).',array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes/404.html\',\'html_ae8471bcdaa5c0d151aa8c0512c0bd4e\',\'\',18,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
        <div class="main">
            <div class="wrapper">
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/footer') . ', array_merge('.var_export($Pile[0],1).',array(\'self\' => ' . argumenter_squelette(self()) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes/404.html\',\'html_ae8471bcdaa5c0d151aa8c0512c0bd4e\',\'\',31,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
    </div><!--.page-->
</body>
</html>
');
	...
	return analyse_resultat_skel('html_ae8471bcdaa5c0d151aa8c0512c0bd4e', $Cache, $page, 'squelettes/404.html');
}
?>