...
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.34.0/saisies_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.34.0/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/metasplus/v2.3.2/metasplus_pipelines.php');
$inc=true;
}
...
$val = minipipe('metasplus_affichage_final', $val);
...
if (!$inc){
include_once_check(_ROOT_PLUGINS_DIST.'compagnon/compagnon_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/info_spip/v0.11.1/info_spip_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/svpstats/v0.3.2/svpstats_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/medias_pipelines.php');
$inc=true;
}
$val = minipipe('compagnon_affiche_gauche', $val);
$val = minipipe('info_spip_affiche_gauche', $val);
$val = minipipe('svpstats_affiche_gauche', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/info_spip/v0.11.1/info_spip_autorisations.php');
include_once_check(_ROOT_PLUGINS.'auto/metasplus/v2.3.2/metasplus_autorisations.php');
...
$val = minipipe('info_spip_autoriser', $val);
$val = minipipe('metasplus_autoriser', $val);
...
$val = minipipe('metasplus_boite_infos', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/svpstats/v0.3.2/base/svpstats_declarer.php');
...
$val = minipipe('svpstats_declarer_tables_interfaces', $val);
...
$val = minipipe('svpstats_declarer_tables_principales', $val);
...
$val = minipipe('svpstats_declarer_tables_auxiliaires', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'mediabox/mediabox_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/spip_proprio/v1.70.5/spip_proprio_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'compresseur/compresseur_pipeline.php');
$inc=true;
}
...
$val = minipipe('spip_proprio_insert_head', $val);
...
$val = minipipe('metasplus_post_edition', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/svpstats/v0.3.2/genie/svpstats_taches_generales_cron.php');
$inc=true;
}
...
$val = minipipe('svpstats_taches_generales_cron', $val);
return $val;
}
