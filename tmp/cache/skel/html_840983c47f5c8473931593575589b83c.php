...
// Temps de compilation total: 0.603 ms
//
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
	...
	'<em class="aide">' .
	interdire_scripts((($aider=charger_fonction('aide','inc',true))?$aider('titre','../plugins-dist/mots/formulaires/editer_mot.html', $Pile[0]):'')) .
	'</em></label>' .
	...
	'<em class="aide">' .
	interdire_scripts((($aider=charger_fonction('aide','inc',true))?$aider('id_groupe','../plugins-dist/mots/formulaires/editer_mot.html', $Pile[0]):'')) .
	'</em></label>' .
