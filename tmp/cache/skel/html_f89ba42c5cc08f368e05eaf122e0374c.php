...
/*
 * Squelette : ../plugins/auto/saisies/v3.36.2/saisies/radio.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Mon, 16 Mar 2020 15:17:04 GMT
 * Boucles :   _radio
 */ 

function BOUCLE_radiohtml_f89ba42c5cc08f368e05eaf122e0374c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins/auto/saisies/v3.36.2/saisies/radio.html','html_f89ba42c5cc08f368e05eaf122e0374c','_radio',28,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
');
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_radio @ ../plugins/auto/saisies/v3.36.2/saisies/radio.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins/auto/saisies/v3.36.2/saisies/radio.html
// Temps de compilation total: 1.488 ms
//

function html_f89ba42c5cc08f368e05eaf122e0374c($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
BOUCLE_radiohtml_f89ba42c5cc08f368e05eaf122e0374c($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_f89ba42c5cc08f368e05eaf122e0374c', $Cache, $page, '../plugins/auto/saisies/v3.36.2/saisies/radio.html');
}
?>