...
// Temps de compilation total: 2.772 ms
//
...
' .
	...
	' .
			bouton_action(_T('medias:lien_tout_enlever'),invalideur_session($Cache, generer_action_auteur('dissocier_document',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
					...
					'-I/image'),invalideur_session($Cache, ancre_url(self(),'illustrations')))),'ajax noscroll tout_supprimer',(	_T('ecrire:lien_tout_supprimer') .
				' ?')) .
			'
	' .
	...
	<div class="actions-liste">
		' .
			bouton_action(_T('medias:lien_tout_enlever'),invalideur_session($Cache, generer_action_auteur('dissocier_document',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
					'-' .
					interdire_scripts(invalideur_session($Cache, @$Pile[0]['objet'])) .
					'-I/document'),invalideur_session($Cache, ancre_url(self(),'portfolio')))),'ajax noscroll tout_supprimer',(	_T('ecrire:lien_tout_supprimer') .
				' ?')) .
			'
		' .
			bouton_action(_T('medias:lien_tout_desordonner'),invalideur_session($Cache, generer_action_auteur('desordonner_liens_documents',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
	...
	<div class="actions-liste">
		' .
			bouton_action(_T('medias:lien_tout_enlever'),invalideur_session($Cache, generer_action_auteur('dissocier_document',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
					'-' .
					interdire_scripts(invalideur_session($Cache, @$Pile[0]['objet'])) .
					'-D/document'),invalideur_session($Cache, ancre_url(self(),'documents')))),'ajax noscroll tout_supprimer',(	_T('ecrire:lien_tout_supprimer') .
				' ?')) .
			'
		' .
			bouton_action(_T('medias:lien_tout_desordonner'),invalideur_session($Cache, generer_action_auteur('desordonner_liens_documents',(	invalideur_session($Cache, @$Pile[0]['id_objet']) .
