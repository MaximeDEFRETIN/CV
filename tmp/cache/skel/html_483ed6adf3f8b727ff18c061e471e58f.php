...
// Temps de compilation total: 0.329 ms
//

function html_483ed6adf3f8b727ff18c061e471e58f($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'analyser', null),true))))!=='' ?
		('
    <a href="' . $t1 . (	'" class="spip-admin-boutons" id="analyser">' .
...
(($t1 = strval(interdire_scripts(((entites_html(table_valeur(@$Pile[0], (string)'objet', null),true)) ?' ' :''))))!=='' ?
	...
	(($t2 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'id_objet', null),true))))!=='' ?
		...
		'" class="spip-admin-boutons" id="voir_' .
...
'" class="spip-admin-boutons" id="var_mode">' .
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'preview', null),true))))!=='' ?
		('
    <a href="' . $t1 . (	'" class="spip-admin-boutons" id="preview">' .
...
');
	...
	return analyse_resultat_skel('html_483ed6adf3f8b727ff18c061e471e58f', $Cache, $page, 'squelettes/formulaires/administration.html');
}
?>