...
/*
 * Squelette : ../plugins/auto/saisies/v3.33.0/saisies/input.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Fri, 21 Feb 2020 08:30:41 GMT
 * Boucles :   _selection
 */ 

function BOUCLE_selectionhtml_79bc4017a17aeb45500951c30b87d9d3(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins/auto/saisies/v3.33.0/saisies/input.html','html_79bc4017a17aeb45500951c30b87d9d3','_selection',54,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_selection @ ../plugins/auto/saisies/v3.33.0/saisies/input.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins/auto/saisies/v3.33.0/saisies/input.html
// Temps de compilation total: 4.466 ms
//

function html_79bc4017a17aeb45500951c30b87d9d3($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = BOUCLE_selectionhtml_79bc4017a17aeb45500951c30b87d9d3($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
' .
...
');
	...
	return analyse_resultat_skel('html_79bc4017a17aeb45500951c30b87d9d3', $Cache, $page, '../plugins/auto/saisies/v3.33.0/saisies/input.html');
}
?>