...
/*
 * Squelette : ../plugins/auto/corbeille/v3.1.2/prive/listes/corbeille_forums_prives.html
 * Date :      Fri, 20 Dec 2019 11:26:22 GMT
 * Compile :   Sun, 08 Mar 2020 10:15:29 GMT
 * Boucles :   _forums_prives
 */ 

function BOUCLE_forums_priveshtml_431dcc1a24c8116af3585f5172abb606(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  'debut_nom' => '\'_forums_prives\'',
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins/auto/corbeille/v3.1.2/prive/listes/corbeille_forums_prives.html','html_431dcc1a24c8116af3585f5172abb606','_forums_prives',1,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
');
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_forums_prives @ ../plugins/auto/corbeille/v3.1.2/prive/listes/corbeille_forums_prives.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins/auto/corbeille/v3.1.2/prive/listes/corbeille_forums_prives.html
// Temps de compilation total: 1.733 ms
//

function html_431dcc1a24c8116af3585f5172abb606($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {

	if (isset($Pile[0]["doublons"]) AND is_array($Pile[0]["doublons"]))
		$doublons = nettoyer_env_doublons($Pile[0]["doublons"]);

	$connect = '';
	$page = (($t1 = BOUCLE_forums_priveshtml_431dcc1a24c8116af3585f5172abb606($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
<div class="liste corbeille-forum corbeille-forum-prives">
' .
		(($t3 = strval(singulier_ou_pluriel((isset($Numrows['_forums_prives']['grand_total'])
			? $Numrows['_forums_prives']['grand_total'] : $Numrows['_forums_prives']['total']),'corbeille:forums_prives_corbeille_un','corbeille:forums_prives_corbeille_tous')))!=='' ?
...
')) :
	...
	return analyse_resultat_skel('html_431dcc1a24c8116af3585f5172abb606', $Cache, $page, '../plugins/auto/corbeille/v3.1.2/prive/listes/corbeille_forums_prives.html');
}
?>