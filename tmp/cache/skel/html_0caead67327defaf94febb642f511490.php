 ...
 * Compile :   Mon, 02 Mar 2020 13:58:24 GMT
 * Boucles :   _ariane, _m2, _miniplan, _sous_rubriques, _articles, _documents_joints, _mots, _principale
 */ 
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_ariane',26,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_miniplan',58,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_sous_rubriques',50,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
...
quete_condition_statut('articles.statut','publie,prop,prepa/auteur','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_articles',33,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
(($t1 = strval(supprimer_tags(recuperer_fond('modeles/lesauteurs', array('objet'=>'article','id_objet' => $Pile[$SP]['id_article'],'id_article' => $Pile[$SP]['id_article']), array('trim'=>true, 'compil'=>array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_articles',38,$GLOBALS['spip_lang'])), ''))))!=='' ?
		((	', ' .
...
quete_condition_statut('documents.statut','publie,prop,prepa','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_documents_joints',76,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_motshtml_0caead67327defaf94febb642f511490(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_mots',97,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/header') . ', array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes/rubrique.html\',\'html_0caead67327defaf94febb642f511490\',\'\',19,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
        ' .

'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/nav') . ', array_merge('.var_export($Pile[0],1).',array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes/rubrique.html\',\'html_0caead67327defaf94febb642f511490\',\'\',20,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
        <div class="main">
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/navsub') . ', array(\'id_rubrique\' => ' . argumenter_squelette($Pile[$SP]['id_rubrique']) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes/rubrique.html\',\'html_0caead67327defaf94febb642f511490\',\'\',95,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
                
                ' .
(($t1 = BOUCLE_motshtml_0caead67327defaf94febb642f511490($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
                    <div class="menu">
                        <h2>' .
...
executer_balise_dynamique('FORMULAIRE_SITE',
	...
	array('squelettes/rubrique.html','html_0caead67327defaf94febb642f511490','_principale',109,$GLOBALS['spip_lang'])) .
'
            </div><!--.aside-->
        </div><!--.main-->
        ' .
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/footer') . ', array_merge('.var_export($Pile[0],1).',array(\'self\' => ' . argumenter_squelette(self()) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes/rubrique.html\',\'html_0caead67327defaf94febb642f511490\',\'\',112,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
    </div><!--.page-->
</body>
</html>
...
// Temps de compilation total: 34.040 ms
//
