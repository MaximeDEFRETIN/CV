 ...
 * Date :      Mon, 10 Feb 2020 16:50:12 GMT
 * Compile :   Thu, 27 Feb 2020 08:55:17 GMT
 * Boucles :   _auteur, _liste_rev
 */ 

function BOUCLE_auteurhtml_d20ae50eb63002acf20ccbec540a10ce(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('auteurs.statut','!5poubelle','!5poubelle',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/revisions/prive/objets/liste/versions.html','html_d20ae50eb63002acf20ccbec540a10ce','_auteur',22,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_liste_revhtml_d20ae50eb63002acf20ccbec540a10ce(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/revisions/prive/objets/liste/versions.html','html_d20ae50eb63002acf20ccbec540a10ce','_liste_rev',5,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
		' .
(($t1 = BOUCLE_auteurhtml_d20ae50eb63002acf20ccbec540a10ce($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		$t1 :
...
// Temps de compilation total: 7.944 ms
//

function html_d20ae50eb63002acf20ccbec540a10ce($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
') :
		'') .
(($t1 = BOUCLE_liste_revhtml_d20ae50eb63002acf20ccbec540a10ce($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
' .
...
');
	...
	return analyse_resultat_skel('html_d20ae50eb63002acf20ccbec540a10ce', $Cache, $page, '../plugins-dist/revisions/prive/objets/liste/versions.html');
}
?>