...
'
&gt; ' .
lien_ou_expose(generer_url_entite($Pile[$SP]['id_auteur'],'auteur'),interdire_scripts(((($a = couper(supprimer_numero(typo($Pile[$SP]['nom']), "TYPO", $connect, $Pile[0]),'80')) OR (is_string($a) AND strlen($a))) ? $a : $l3)),'1') .
'
');
	}
	$iter->free();
...
// Temps de compilation total: 3.645 ms
//
