...
/*
 * Squelette : ../plugins/auto/saisies/v3.33.0/saisies/_base.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Fri, 21 Feb 2020 08:30:41 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins/auto/saisies/v3.33.0/saisies/_base.html
// Temps de compilation total: 4.883 ms
//

function html_e362e7f60c049247df2fe33cc322c496($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = strval(interdire_scripts(((entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)) ?' ' :''))))!=='' ?
	...
	'readonly' => table_valeur($Pile["vars"], (string)'readonly', null) )), array('compil'=>array('../plugins/auto/saisies/v3.33.0/saisies/_base.html','html_e362e7f60c049247df2fe33cc322c496','',12,$GLOBALS['spip_lang'])), _request('connect')) .
		'
	')) :
			'') .
	'
	...
	'describedby' => interdire_scripts((table_valeur(@$Pile[0], (string)'explication', null) ? (($t5 = strval(interdire_scripts(saisie_nom2name(entites_html(table_valeur(@$Pile[0], (string)'nom', null),true)))))!=='' ?
						('explication_' . $t5) :
						''):'')) )), array('compil'=>array('../plugins/auto/saisies/v3.33.0/saisies/_base.html','html_e362e7f60c049247df2fe33cc322c496','',0,$GLOBALS['spip_lang'])), _request('connect')) .
		'
			' .
...
');
	...
	return analyse_resultat_skel('html_e362e7f60c049247df2fe33cc322c496', $Cache, $page, '../plugins/auto/saisies/v3.33.0/saisies/_base.html');
}
?>