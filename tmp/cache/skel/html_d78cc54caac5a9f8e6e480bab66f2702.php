 ...
 * Compile :   Thu, 27 Feb 2020 09:02:09 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../prive/squelettes/contenu/articles.html
// Temps de compilation total: 0.936 ms
//

function html_d78cc54caac5a9f8e6e480bab66f2702($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
executer_balise_dynamique('FORMULAIRE_RECHERCHE_ECRIRE',
	array(self(),'ajax'),
	array('../prive/squelettes/contenu/articles.html','html_d78cc54caac5a9f8e6e480bab66f2702','',9,$GLOBALS['spip_lang'])) .
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/liste/articles') . ', array_merge('.var_export($Pile[0],1).',array(\'statut\' => ' . argumenter_squelette(table_valeur($Pile["vars"], (string)'statuts', null)) . ',
	...
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../prive/squelettes/contenu/articles.html\',\'html_d78cc54caac5a9f8e6e480bab66f2702\',\'\',14,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette(@$Pile[0]['ajax']) . '))?$v:true), _request("connect"));
?'.'>
...
');
	...
	return analyse_resultat_skel('html_d78cc54caac5a9f8e6e480bab66f2702', $Cache, $page, '../prive/squelettes/contenu/articles.html');
}
?>