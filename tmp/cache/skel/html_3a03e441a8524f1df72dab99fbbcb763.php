...
/*
 * Squelette : ../plugins/auto/saisies/v3.36.2/saisies/input.html
 * Date :      Fri, 20 Dec 2019 11:26:28 GMT
 * Compile :   Mon, 16 Mar 2020 15:17:04 GMT
 * Boucles :   _selection
 */ 

function BOUCLE_selectionhtml_3a03e441a8524f1df72dab99fbbcb763(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins/auto/saisies/v3.36.2/saisies/input.html','html_3a03e441a8524f1df72dab99fbbcb763','_selection',54,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
');
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_selection @ ../plugins/auto/saisies/v3.36.2/saisies/input.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins/auto/saisies/v3.36.2/saisies/input.html
// Temps de compilation total: 1.297 ms
//

function html_3a03e441a8524f1df72dab99fbbcb763($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = BOUCLE_selectionhtml_3a03e441a8524f1df72dab99fbbcb763($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
' .
...
');
	...
	return analyse_resultat_skel('html_3a03e441a8524f1df72dab99fbbcb763', $Cache, $page, '../plugins/auto/saisies/v3.36.2/saisies/input.html');
}
?>