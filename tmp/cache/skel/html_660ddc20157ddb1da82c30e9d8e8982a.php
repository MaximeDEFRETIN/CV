...
/*
 * Squelette : prive/modeles/pagination.html
 * Date :      Mon, 10 Feb 2020 16:50:04 GMT
 * Compile :   Sun, 01 Mar 2020 05:01:53 GMT
 * Boucles :   _pages
 */ 

function BOUCLE_pageshtml_660ddc20157ddb1da82c30e9d8e8982a(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('prive/modeles/pagination.html','html_660ddc20157ddb1da82c30e9d8e8982a','_pages',7,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
(($t1 = strval(interdire_scripts((($Pile[$SP]['valeur'] < table_valeur($Pile["vars"], (string)'derniere', null)) ? table_valeur($Pile["vars"], (string)'sep', null):''))))!=='' ?
	...
	AND 1000*($timer = (time()+(float)microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_pages @ prive/modeles/pagination.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette prive/modeles/pagination.html
// Temps de compilation total: 3.198 ms
//

function html_660ddc20157ddb1da82c30e9d8e8982a($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(($t1 = BOUCLE_pageshtml_660ddc20157ddb1da82c30e9d8e8982a($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
	' .
...
')) :
	...
	return analyse_resultat_skel('html_660ddc20157ddb1da82c30e9d8e8982a', $Cache, $page, 'prive/modeles/pagination.html');
}
?>