...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('formulaires/inc-admin_plugin') . ', array_merge('.var_export($Pile[0],1).',array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../plugins-dist/svp/formulaires/admin_plugin.html\',\'html_252dd4d4b1a94014d18bf7ec787f6bec\',\'\',26,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
			</fieldset>
		</div>
