...
/*
 * Squelette : ../plugins-dist/organiseur/formulaires/configurer_messagerie_agenda.html
 * Date :      Mon, 10 Feb 2020 16:50:07 GMT
 * Compile :   Thu, 27 Feb 2020 08:57:56 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../plugins-dist/organiseur/formulaires/configurer_messagerie_agenda.html
// Temps de compilation total: 0.396 ms
//

function html_202fda033ff067ed5ddfaf1865d05890($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
interdire_scripts(chemin_image('messagerie-24.png')) .
'" class="cadre-icone" />' .
_T('public|spip|ecrire:titre_messagerie_agenda') .
'</h3>
	' .
...
(($t1 = strval(interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'editable', null),true))))!=='' ?
		($t1 . (	'
	<p>' .
	_T('public|spip|ecrire:texte_messagerie_agenda') .
	'</p>
	...
	'</div>
		<div class="editer-groupe">
			' .
	vide($Pile['vars'][$_zzz=(string)'name'] = 'messagerie_agenda') .
	...
	table_valeur($Pile["vars"], (string)'name', null) .
	'_oui">' .
	_T('public|spip|ecrire:item_messagerie_agenda') .
	'</label>
					</div>
					<div class="choix">
						<input type="radio" name="' .
	...
	table_valeur($Pile["vars"], (string)'name', null) .
	'_non">' .
	_T('public|spip|ecrire:item_non_messagerie_agenda') .
	'</label>
					</div>
			</div>
		</div>
...
');
	...
	return analyse_resultat_skel('html_202fda033ff067ed5ddfaf1865d05890', $Cache, $page, '../plugins-dist/organiseur/formulaires/configurer_messagerie_agenda.html');
}
?>