...
// Temps de compilation total: 280.105 ms
//

function html_4efc0080d0d07f4680aa17f4911fe369($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
(!(table_valeur($Pile["vars"], (string)'fin', null))  ?
	...
	vide($Pile['vars'][$_zzz=(string)'dir_img'] = concat('<i>',joli_repertoire((defined('_DIR_IMG')?constant('_DIR_IMG'):'')),'</i>')) .
...
'img' => table_valeur($Pile["vars"], (string)'dir_img', null))) .
	...
	array(),
	array('../plugins-dist/dump/prive/squelettes/contenu/sauvegarder.html','html_4efc0080d0d07f4680aa17f4911fe369','',16,$GLOBALS['spip_lang'])) .
	'
	</div>
	...
	'delete' => invalideur_session($Cache, ((function_exists("autoriser")||include_spip("inc/autoriser"))&&autoriser('webmestre')?" ":"")) )), array('ajax' => ($v=( @$Pile[0]['ajax'] ))?$v:true,'compil'=>array('../plugins-dist/dump/prive/squelettes/contenu/sauvegarder.html','html_4efc0080d0d07f4680aa17f4911fe369','',19,$GLOBALS['spip_lang'])), _request('connect'))))!=='' ?
			('
		' . $t2 . '
	') :
			'') .
...
')) :
	...
	return analyse_resultat_skel('html_4efc0080d0d07f4680aa17f4911fe369', $Cache, $page, '../plugins-dist/dump/prive/squelettes/contenu/sauvegarder.html');
}
?>